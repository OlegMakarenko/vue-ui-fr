...
const HTTP_BASE_URL = "http://vega-test.fractal.tools/request"; //<--vega-staging |create 2 branches| vega-test-->// http://vega-test.fractal.tools/request
const WEB_SOCKET_ENDPOINT = "ws://vega-test.fractal.tools/ws" //<--vega-staging |create 2 branches| vega-test-->// ws://vega-test.fractal.tools/ws
